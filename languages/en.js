if( currentLanguage == "en"){
	app.controller("language", function ($scope) {
    	    $scope.language = {
			 ...
			 "slide4-menu-3": '',
			 // slie5
			 "slide5-title-1": 'Labor Share Network',
			 "slide5-title-2": 'Subscribe',
			 "slide5-button": 'Subscribe',
			 "slide5-p": 'Subscribe and get more information in time!',
			 "slide5-placeholder": 'Please enter your email address',
			 // slie6
			 "slide6-title-1": 'Labor Share Network',
			 "slide6-title-2": 'Contact Us',
			 "slide6-p": 'Questions, consultation, cooperation, etc., we are looking forward to hearing from you',
			 ...
			 "token-progress-p-1": '39%',
 
			 "token-progress-title-2": 'Team Operation',
			 "token-progress-p-2": '30%',
 
			 "token-progress-title-3": 'Team Motivation',
			 "token-progress-p-3": '20%',
 
			 "token-progress-title-4": 'Technical application development',
			 "token-progress-p-4": '11%',
	    };
	});
}